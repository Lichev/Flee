...
<template>
  <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <div class="flex items-center space-x-2">
              ...
              <p class="text-xs"><strong>Radoslav Lichev</strong></p>
            </div>
    ...
    <!--Contact list end here -->

    <!--Center section starts here -->
    <div class="main-center col-span-3 space-y-4">
      <!-- Messages fields starts here -->
      <div class="bg-white border border-gray-200 rounded-lg">
        <div class="flex flex-col flex-grow p-4">

          <!-- Your message fields starts here -->
          ...
          <!-- Your message fields ens here -->


          <!-- Their message fields starts here -->
          ...
          <!-- Their message fields ends here -->
        </div>
      </div>
      <!-- Messages fields ends here -->

      <!-- Post message field starts here -->
      <div class="bg-white border border-gray-200 rounded-lg">
        <div class="p-4">
